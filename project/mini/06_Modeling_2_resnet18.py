...
def conv3_layer(x):        
    ...
    for i in range(2):     
        if(i == 0): 
            ...
            shortcut = Conv2D(128, (3, 3), strides=(1, 1), padding='valid')(shortcut)
            x = BatchNormalization()(x)
            shortcut = BatchNormalization()(shortcut)            
...
def conv4_layer(x):
    ...
    for i in range(2):     
        if(i == 0):
            ...
            shortcut = Conv2D(256, (3, 3), strides=(1, 1), padding='valid')(shortcut)
            x = BatchNormalization()(x)
            shortcut = BatchNormalization()(shortcut)
...
def conv5_layer(x):
    ...
    for i in range(2):     
        if(i == 0):
            ...
            shortcut = Conv2D(512, (3, 3), strides=(1, 1), padding='valid')(shortcut)
            x = BatchNormalization()(x)
            shortcut = BatchNormalization()(shortcut)            
...
file_path = './project/mini/data/genre_model_resnet18.hdf5'
...
# Epoch 277/5000
# 155/155 - 119s - loss: 5.5393e-04 - accuracy: 1.0000 - val_loss: 3.1132 - val_accuracy: 0.6425
# 아마 이때 cp가 저장된 것 같음.
