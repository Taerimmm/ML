...
# L1.
w1 = tf.get_variable('w1', shape=[2, 2, 1, 32])             # 3, 3 : kernel_size , 1 : color , 32 : out_channel
...
# Flatten
L_flat = tf.reshape(L2, [-1, 7*7*64])
print('Flattne :', L_flat)

# L5.
w5 = tf.get_variable('w5', shape=[7*7*64, 256], initializer=tf.contrib.layers.xavier_initializer())
...
# L6.
w6 = tf.get_variable('w6', shape=[256, 32], initializer=tf.contrib.layers.xavier_initializer())
