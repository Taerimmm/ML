...
# L1.
w1 = tf.compat.v1.get_variable('w1', shape=[2, 2, 1, 32])             # 3, 3 : kernel_size , 1 : color , 32 : out_channel
...
# L2.
w2 = tf.compat.v1.get_variable('w2', shape=[2, 2, 32, 32])             
...
# L3.
w3 = tf.compat.v1.get_variable('w3', shape=[2, 2, 32, 64])             
...
b7 = tf.Variable(tf.random.normal([10]), name= 'b2')
