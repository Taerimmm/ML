...
def solution_model():
    ...
    urllib.request.urlretrieve(_TRAIN_URL, './tf_certificate/Category6/horse-or-human.zip')
    local_zip = './tf_certificate/Category6/horse-or-human.zip'
    zip_ref = zipfile.ZipFile(local_zip, 'r')
    zip_ref.extractall('./tf_certificate/Category6/tmp/horse-or-human/')
    zip_ref.close()
    urllib.request.urlretrieve(_TEST_URL, './tf_certificate/Category6/testdata.zip')
    local_zip = './tf_certificate/Category6/testdata.zip'
    zip_ref = zipfile.ZipFile(local_zip, 'r')
    zip_ref.extractall('./tf_certificate/Category6/tmp/testdata/')
    zip_ref.close()
    ...
    train_generator = train_datagen.flow_from_directory(
        './tf_certificate/Category6/tmp/horse-or-human/',
        target_size=(300,300),
        class_mode="binary",
        subset='training'
        #Your Code Here)
    ...
    validation_generator = validation_datagen.flow_from_directory(
        #Your Code Here)
        './tf_certificate/Category6/tmp/testdata/',
        target_size=(300,300),
        class_mode="binary",
        subset='validation'
    )
...
if __name__ == '__main__':
    ...
    model.save("./tf_certificate/Category6/mymodel.h5")