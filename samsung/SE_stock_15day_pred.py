...
stock = np.load('./samsung/etc/15day_data.npy')
...
# model = load_model('./samsung/etc/15day_stock_model.h5')
model = load_model('./samsung/etc/15day_model_checkpoint.hdf5')
