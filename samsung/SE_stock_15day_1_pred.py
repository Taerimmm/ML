...
# X, Y 나누기
x_data = pd.DataFrame(np.load('./samsung/etc/15day_data_1.npy'))
...
model = load_model('./samsung/etc/15day_model_checkpoint_1.hdf5')
# model = load_model('./samsung/etc/15day_stock_model_1.h5')
