...
np.save('./samsung/etc/15day_data.npy', arr=x_data)
...
print(x_data[:-1].shape)        # (2370, 28, 7)
print(y_target.shape)           # (2370,)
...
np.save('./samsung/etc/15day_x_train.npy', arr=x_train)
np.save('./samsung/etc/15day_x_test.npy', arr=x_test)
np.save('./samsung/etc/15day_y_train.npy', arr=y_train)
np.save('./samsung/etc/15day_y_test.npy', arr=y_test)
...
modelpath = './samsung/etc/15day_model_checkpoint.hdf5'
...
model.save('./samsung/etc/15day_stock_model.h5')
