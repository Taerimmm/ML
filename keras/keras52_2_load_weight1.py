...
# 로드모델_loss : 0.043560635298490524
# 로드모델_accuracy : 0.9894000291824341

'''
weight 값만 필요하다면 save_wieght
무델을 저장하고 다시 훈련시키고 싶다면 모델만 save
모델부터 weight 까지 다 필요하면 훈련이 끝난후 save
'''