...
x_train_data = np.load('../data/npy/cifar10_x_train.npy')
x_test_data = np.load('../data/npy/cifar10_x_test.npy')
y_train_data = np.load('../data/npy/cifar10_y_train.npy')
y_test_data = np.load('../data/npy/cifar10_y_test.npy')
...
# Result
# loss : 1.234971523284912
# ACC : 0.7580000162124634