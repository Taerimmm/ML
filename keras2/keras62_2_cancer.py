...
def dnn_model(node=32, drop=0.3, activation='relu', optimizer='adam'):
    ...
    outputs = Dense(2, activation='sigmoid', name='output')(layer)
...
# {'optimizer': 'nadam', 'node': 32, 'drop': 0.3, 'batch_size': 20, 'activation': 'swish'}
# search.best_score_ : 0.969240128993988
# search.score       : 0.9824561476707458
