...
vgg19 = VGG19(weights='imagenet', include_top=False, input_shape=x_train.shape[1:])
...
# Epoch 61/1000
# loss: 1.0898 - accuracy: 0.6243 - val_loss: 1.1865 - val_accuracy: 0.5979
